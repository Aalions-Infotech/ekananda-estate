              ...
              <div className="sticky top-20 space-y-4">
                ...
                <div className="bg-card rounded-2xl border border-border p-5 shadow-card">
                  <div className="flex items-center gap-3 mb-5 pb-4 border-b border-border">
                    ...
                    <div>
                      <p className="font-display font-semibold text-sm">{ownerName}</p>
                      <p className="text-xs text-muted-foreground">{ownerPhone ? `+91 ${ownerPhone.slice(-10)}` : city}</p>
                    </div>
                  </div>
                  <div className="space-y-3">
                    <a
                      href={`https://wa.me/${waNumber}?text=${encodeURIComponent(enquiryText)}`}
                      target="_blank"
                    ...
                    {ownerPhone ? (
                      <>
                        <a
                          href={`tel:+91${ownerPhone.slice(-10)}`}
                        ...
                        <a
                          href={`sms:+91${ownerPhone.slice(-10)}?&body=${encodeURIComponent(enquiryText)}`}
                          className="w-full btn-navy py-3 rounded-xl flex items-center justify-center gap-2 text-sm"
                        >
                      ...
                      <>
                        <button
                          onClick={() => document.getElementById("lead-form-anchor")?.scrollIntoView({ behavior: "smooth" })}
                          className="w-full btn-gold py-3 rounded-xl flex items-center justify-center gap-2 text-sm"
                        >
                          <Phone className="w-4 h-4" /> Contact Owner
                        </button>
